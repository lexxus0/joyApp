...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="mt-40 mb-20 max-w-4xl mx-auto p-8  text-gray-100 shadow-md rounded-lg">
      ...
      <div className="space-y-8">
        <div>
          ...
          <div className="flex flex-col space-y-4">
            <input
              ...
              className="p-3 border border-gray-700 bg-gray-800 rounded focus:outline-none focus:border-blue-500 text-gray-100"
            />
            <button
        ...
        <div>
          ...
          <Switch.Group>
            <div className="flex items-center">
              <Switch.Label className="mr-4 text-gray-100">
                Dark Mode
              </Switch.Label>
              <Switch
        ...
        <div>
          ...
          <select
            ...
            className="block w-full p-2.5 bg-gray-800 border border-gray-700 text-gray-100 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          >
            {languages.map((lang) => (
